...
export const KPICard = ({ title, value, type, count, compareValue, compareLabel }: KPICardProps) => {
  ...
  return (
    <div className="bg-[#252849]/70 rounded-2xl p-4 flex flex-col justify-between min-h-40 relative overflow-hidden border border-slate-700/50">
      ...
      <div className="mt-2">
        ...
        {count && (<p className="text-xs text-slate-400 mt-1">{count} {count === 1 ? 'patient' : 'patients'}</p>)}
      ...
      <div className="w-full bg-slate-700/50 h-1 rounded-full mt-auto">
