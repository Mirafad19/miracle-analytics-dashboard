...
export const DashboardFilters = ({ 
  ...
  const dateInputClasses = "bg-slate-900/50 border border-slate-700 rounded-md px-2 py-1 text-sm text-white focus:outline-none focus:ring-2 focus:ring-purple-500 disabled:opacity-50";
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex flex-wrap items-center gap-x-6 gap-y-4 flex-1">
            ...
            {availableMonths.length > 1 && (
                <>
                    ...
                    <div className="flex items-center gap-2">
                        <label className="text-sm font-medium text-slate-400">Compare to:</label>
                        <Select 
            ...
            <div className="flex items-center gap-2">
                ...
                {(dateRange.start || dateRange.end) && (
                  <Button onClick={clearDates} className="p-1 h-auto bg-transparent hover:bg-slate-800/60 text-slate-400 hover:text-white">
                    <X className="h-4 w-4" />
                  </Button>
                )}
            </div>
        ...
        <div className="text-xs text-blue-300 bg-blue-500/20 px-3 py-1 rounded-full border border-blue-400/30 whitespace-nowrap">
